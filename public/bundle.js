			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement('input', { type: 'text', className: 'form-control', ref: 'username', placeholder: 'Github username' })
					),
					React.createElement(
						'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Profile = React.createClass({
		...
		componentDidMount: function componentDidMount() {
			this.ref = new Firebase('https://amzani-github-note.firebaseio.com');
			this.init();
		},
		componentWillUnmount: function componentWillUnmount() {
			this.unbind('notes');
